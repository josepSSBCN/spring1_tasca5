        ...
        try {
            ...
            do {
                ...
                switch (userOption) {
                    ...
                    case 7 -> text = encryptFilesAESECB(path);
                    case 8 -> text = encryptFilesAESCBC(path);
                    case 9 -> text = dencryptFilesAESECB(path);
                    case 10 -> text = dencryptFilesAESCBC(path);
                }
...
//                + "Selecciona una de les opcions";
    ...
    private static String encryptFilesAESECB(String pathInFIle) {
        //region DEFINITION VARIABLES
        String text = "", pathOutFile = "", mode = "";
    ...
    private static String encryptFilesAESCBC(String pathInFIle) {
        //region DEFINITION VARIABLES
        String text = "", pathOutFile = "";
    ...
    private static String dencryptFilesAESECB(String pathInFIle) {
        //region DEFINITION VARIABLES
        String text = "", pathOutFile = "", mode = "";
    ...
    private static String dencryptFilesAESCBC(String pathInFIle) {
        //region DEFINITION VARIABLES
        String text = "", pathOutFile = "";
        ...
        try {
            ...
            if(pathInFIle.isEmpty()) {
                // 1) Ask user what file would dencrypt
                pathInFIle = ToolsGlbl.scannerStrg(text + "\r\nEntri el path complet de l'arxiu que vol encriptar (p.ex. D:\\Temp\\S105N1E3_encECB.cyp)", true);
                pathInFIle = ToolsGlbl.scannerStrg(text + "\r\nEntri el path complet de l'arxiu que vol desencriptar (p.ex. D:\\Temp\\S105N1E3_encCBC.cyp)", true);
            }
            pathOutFile = ToolsGlbl.scannerStrg("\r\nEntri el path complet de l'arxiu on vol deixar el desenctriptat. (p.ex. D:\\Temp\\S105N1E3_dencCBC.txt)", true);
